# V3 checkpoint fixtures

`rules-runtime-package-v3-checkpoint1.json` is an exact test-only copy of
`contracts/examples/v3/rules-runtime-package.json` from commit
`d0b8a316f2e653654659b9bf7da50669d2372f7c` on the separate delivery worktree.
