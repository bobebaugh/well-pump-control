...
CONSTANTS = {
    "RULES_V3_INHIBITION_OBJECT", "RULES_V3_PUMP_RUNNING_OBJECT",
    ...
    def v3_runtime_body(self, release_id="20260830000000-event-v3-v1", version=1):
        return json.dumps({
            ...
            "devices": [{"id": "tab5-main", "driver": "tab5-runtime", "address": "local",
                         "enabled": True, "fields": [{"systemName": "ADCCount", "type": "integer",
                         "unit": "count", "logging": {"mode": "delta", "threshold": 10},
                         "object": "values.adc_raw", "access": "read"}]}],
            "calculations": [],
