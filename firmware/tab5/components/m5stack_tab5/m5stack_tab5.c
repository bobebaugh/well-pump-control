...
#else
    static lv_indev_drv_t disp_indev_drv;
    lv_indev_drv_init(&disp_indev_drv);
    disp_indev_drv.type = LV_INDEV_TYPE_POINTER;
    disp_indev_drv.read_cb = lvgl_read_cb;
    disp_indev = lv_indev_drv_register(&disp_indev_drv);
#endif
